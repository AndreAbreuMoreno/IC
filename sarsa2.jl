...
function calculaRecompensa(result, proximo_estado, estado, acao, linhat0)
      recompensa = 0
      if estado[1] == NPOS
            recompensa = 0
      elseif estado[1] == LONG
            println(result, linhat0[4], " ",proximo_estado[10])
...
while !eof(dados)
      ...
      """ Executa a açao """
            ...
            """ Calcula recompensa"""
            recompensa = calculaRecompensa(result, proximo_estado, estado,acao, linhat0)
...
while !eof(dados)
      ...
      linhat0=split(readline(dados),"\t")
      linhat0= parse.(Float32,linhat0[3:8])
      r = calculaRecompensa(result, proximo_estado, estado, acao, linhat0)
      append!(historico, r)
