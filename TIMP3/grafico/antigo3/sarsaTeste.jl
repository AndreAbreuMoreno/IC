...
dadosTeste = "dados/TIMP3teste.csv"
...
while !eof(dados)
      ...
      println(result, "recompensa: ", proxima_recompensa, " recomp_acumulada: ", recompensa_acumulada," long: ", preco_long, " short: ", preco_short)
      ...
      Q_e_a[acao] = atualizaQ(acao, proxima_acao, proxima_recompensa, taxa_aprendizado, fator_desconto)
