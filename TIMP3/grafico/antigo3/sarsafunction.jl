...
function atualizaQ(acao, proxima_acao, proxima_recompensa, taxa_aprendizado, fator_desconto)
      val = Q_e_a[acao] + taxa_aprendizado * (proxima_recompensa + fator_desconto * Q_e_a[proxima_acao] - Q_e_a[acao])
      return val
end
